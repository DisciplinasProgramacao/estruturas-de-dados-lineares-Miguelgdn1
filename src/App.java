...
public class App {
   ...
   static Lista<Pedido> listaPedidos = new Lista<>();
       ...
       private static Lista<Pedido> pilhaPedidos;
...
public static void obterFaturamento() {
    ...
    System.out.printf("Faturamento do comércio: R$ %.2f%n", faturamentoTotal);
}
...
public static void contarPedidosPorData() {
    ...
    System.out.printf("Quantidade de pedidos realizados neste periodo: %d%n", quantidade);
}
